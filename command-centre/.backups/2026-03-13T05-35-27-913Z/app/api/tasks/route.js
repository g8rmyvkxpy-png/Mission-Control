...
Add the comment `// TEST COMMENT` as the first line of the file, before any existing code. The file should start with this comment followed by a blank line, then the existing code.